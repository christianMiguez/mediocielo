...
// when click on services-btn, open a modal for schedule a visit
$(".agende-su-visita").on("click", function() {
  // hide/show button 
  $("#schedule-visit-modal").modal("show");
  $(".agende-su-visita").toggleClass("d-none");
});

// when modal close, show button
$("#schedule-visit-modal").on("hidden.bs.modal", function() {
  $(".agende-su-visita").toggleClass("d-none");
});

// send schedule visit form via WhatsApp
$("#schedule-visit-send").on("click", function() {
